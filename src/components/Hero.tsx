...
const Hero = () => {
  return (
    <section
      className="hero-background relative flex items-center overflow-hidden pt-[56px] pb-1 md:pt-[112px] md:pb-16 min-h-[600px] sm:min-h-[660px] md:min-h-[720px] lg:min-h-[780px] xl:min-h-[840px]"
      style={{
